...
<a href="#" onclick="sendCmd('PAUSED');"><i class="material-icons" style="font-size:80px;color:white">pause_circle</i></a>
<a href="#" onclick="sendCmd('PLAYED');"><i class="material-icons" style="font-size:80px;color:white">play_circle</i></a>
